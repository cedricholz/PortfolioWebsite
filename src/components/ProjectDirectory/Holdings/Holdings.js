    ...
    return (
        <div className="DashClass">
            ...
            <div className="TextBlock">
                ...
                <img alt="" className="MobileImages Image" src={`${ASSETS_BASE_URL}Portfolio.png`}/>
                ...
                <img alt="" className="MobileImages Image" src={`${ASSETS_BASE_URL}addcoin.png`}/>
                <img alt="" className="MobileImages Image" src={`${ASSETS_BASE_URL}addexchange.png`}/>
                ...
                <a href="https://play.google.com/store/apps/details?id=com.automatedcryptocurrencyportfolio">
                    <img alt="" src={`${ASSETS_BASE_URL}playicon.png`}/>
                </a>
            </div>
